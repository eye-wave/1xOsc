...
impl Default for OneXOsc {
    fn default() -> Self {
        Self {
            params: Arc::new(OneXOscParams::default()),
...
impl Default for OneXOscParams {
    fn default() -> Self {
        Self {
            gain: FloatParam::new(
                "Gain",
...
impl Plugin for OneXOsc {
    const NAME: &'static str = "1xOSC";
    const VENDOR: &'static str = "Funny plugins.net";
...
impl ClapPlugin for OneXOsc {
    const CLAP_ID: &'static str = "com.funny-plugins.net";
    const CLAP_DESCRIPTION: Option<&'static str> =
        Some("A simple polyphonic synthesizer with support for polyphonic modulation ( with a gui1!!111!!!)");
...
// modulation
impl Vst3Plugin for OneXOsc {
    const VST3_CLASS_ID: [u8; 16] = *b"1xOSC           ";
...
nih_export_clap!(OneXOsc);
nih_export_vst3!(OneXOsc);
